...
class Pallete {
  ...
  // static const Color firstSuggestionBoxColor = Colors.red;

  static const Color secondSuggestionBoxColor = Color.fromRGBO(157, 202, 235, 1);
  // static const Color secondSuggestionBoxColor = Colors.blueAccent;


  static const Color thirdSuggestionBoxColor = Color.fromRGBO(162, 238, 239, 1);
  // static const Color thirdSuggestionBoxColor = Colors.yellow;



  // static const Color assistantCircleColor = Color.fromRGBO(209, 243, 249, 1);
  static const Color assistantCircleColor = Color.fromRGBO(248, 100, 90,1);
